# Generated by Django 5.0.6 on 2025-02-13 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='default.jpg', null=True, upload_to='events_images/')),
            ],
        ),
        migrations.CreateModel(
            name='Menu',
        ...
        migrations.AddField(
            model_name='menu',
            name='subcategory',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='foods', to='home.subcategory'),
        ),
    ]
